...
STDOUT_FILE=$LOGS_DIR/feignclient.log
...
nohup java $COMMON_OPTS $JAVA_DEBUG_OPTS -classpath $CONF_DIR:$LIB_JARS com.scnu.zzq.feignclient.FeignMain > $STDOUT_FILE 2>&1 &
